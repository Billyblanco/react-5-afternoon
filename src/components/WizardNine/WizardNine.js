...
import { updateAddressThree, updateAddressTwo, updateAddressOne } from '../../ducks/ActionReducer.js';


class WizardNine extends Component {

    render(){
        const { updateAddressThree, updateAddressTwo, updateAddressOne } = this.props
        return(
...
export default connect(mapStateToProps, {updateAddressThree, updateAddressTwo, updateAddressOne})(WizardNine);